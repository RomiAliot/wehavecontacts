...
class We_Have_Contacts_Loader {
	 ...
	 *
	 * @since    1.0.0
	 * @param    $tag                        The name of the WordPress shortcode that is being registered.
	 * @param    $component                  A reference to the instance of the object on which the shortcode is defined.
	 * @param    $callback                   he name of the function definition on the $component.
